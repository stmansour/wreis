...
if [ "${SINGLETEST}${TFILES}" = "${TFILES}" -o "${SINGLETEST}${TFILES}" = "${TFILES}${TFILES}" ]; then
    ...
    # write it
    encodeRequest '{"cmd":"save","record":{"recid":4,"FlowState":1,"PID":0,"PRID":4,"Name":"Sallys Sludge Salon","YearFounded":5,"ParentCompany":"","URL":"https://bbe.com/","Symbol":"","Price":77777.88,"DownPayment":510000,"RentableArea":16000,"RentableAreaUnits":0,"LotSize":26,"LotSizeUnits":1,"CapRate":0.28,"AvgCap":0.35,"BuildYear":1975,"RenovationYear":0,"FLAGS":2,"Ownership":1,"TenantTradeName":"Sallys Sludge Salon","LeaseGuarantor":1,"LeaseType":2,"OriginalLeaseTerm":31,"RentCommencementDt":"Fri, 15 Jun 2018 07:00:00 GMT","LeaseExpirationDt":"Mon, 15 Jun 2020 07:00:00 GMT","ROLID":2,"RSLID":3,"Address":"1235 Elm Street","Address2":"","City":"Goober","State":"AK","PostalCode":"12345","Country":"USA","LLResponsibilities":"","NOI":25000,"HQCity":"Goober","HQState":"AK","CreateTime":"1900-01-01 00:00:00 UTC","CreateBy":0,"LastModTime":"1900-01-01 00:00:00 UTC","LastModBy":0}}'
