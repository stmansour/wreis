...
func BuildPreparedStatements() {
	...
	// Property
	//==========================================
	flds = "PRID,ROLID,RSLID,FlowState,Name,YearFounded,ParentCompany,URL,Symbol,Price,DownPayment,RentableArea,RentableAreaUnits,LotSize,LotSizeUnits,CapRate,AvgCap,BuildDate,FLAGS,Ownership,TenantTradeName,LeaseGuarantor,LeaseType,DeliveryDt,OriginalLeaseTerm,RentCommencementDt,LeaseExpirationDt,TermRemainingOnLease,TermRemainingOnLeaseUnits,Address,Address2,City,State,PostalCode,Country,LLResponsibilities,NOI,HQCity,HQState,Img1,Img2,Img3,Img4,Img5,Img6,Img7,Img8,CreateTime,CreateBy,LastModTime,LastModBy"
